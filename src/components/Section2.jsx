...
const Section2 = () => {
    return (
        <div className="text-[#FFF] lg:flex lg:items-center lg:px-28">
            <div className='w-full flex lg:block flex-col items-center text-center lg:text-left lg:pr-16 pt-24 pb-8'>
                <h1 className=' text-4xl lg:text-6xl font-bold tracking-wide lg:tracking-tight'>Experience the <span className='text-[#1C75BC]'>Future</span> of <span className='text-[#1C75BC]'>Home</span> Automation</h1>
